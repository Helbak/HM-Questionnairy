...
public class QuestionnaireeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final String q5 = request.getParameter("question5");
        ...
        String ansv = "<br/>"+q5+"<br/>"+" Your answer to the first question   "+q1+ " it gives you  "+idx1+" points"+
                "<br/>"+ "<br/> Your answer to the second question   "+q2+ " it gives you  "+idx2+" points"+
                "<br/>"+ "<br/> Your answer to the third question   "+q3+ " it gives you  "+idx3+" points"+
                "<br/>"+ "<br/> Your answer to the fourth question   "+q4+ " it gives you  "+idx4+" points"+
                "<br/>"+"<br/><h2> your total score " +sum +"</h2>";
